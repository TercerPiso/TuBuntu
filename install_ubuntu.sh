...
sudo apt update
sudo apt -y -m install apt-transport-https ca-certificates curl software-properties-common gdebi-core udisks2 zsh software-properties-common python3.8 python-is-python3 docker-ce docker-compose unityhub v4l2loopback-dkms obs-studio libc6 libncurses6 libstdc++6 lib32z1 libbz2-1.0 htop gparted gimp vlc mc neofetch gcc default-jre unrar gtk2-engines-murrine gtk2-engines-pixbuf sassc filezilla
